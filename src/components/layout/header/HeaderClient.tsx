          ...
          <div className="gap-6 flex items-center">
            {hasExpertProfile ? (
              ...
              <Button
                ...
                className="text-base text-exford-blue font-bold bg-white max-w-[163px] h-[48px] border border-light-blue-gray hover:bg-[#004aa9] hover:border-[#004aa9] hover:text-white rounded-[8px] font-figtree hidden lg:flex"
              />
            )}
